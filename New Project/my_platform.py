...
background_image=pygame.image.load("E:/Программирование/Python/New Project/sky.jpg")
screen.blit(background_image, (0, 0))



icon=pygame.image.load("E:/Программирование/Python/New Project/new/syobon2.png")
...
lose= play.new_text(words='YOU LOSE! OSCAR HATES WATER! BRR!', x=0, y=play.screen.bottom+80, size=70, color="red")
win= play.new_text(words='YOU WIN! NOW OSCAR ISNT HUNGRY! YAY!', x=0, y=play.screen.bottom+80, size=70, color="green")
...
korm=play.new_image(image="E:/Программирование/Python/New Project/корм.png",x=170,y=-120,size=7)
...
def draw_platforms():
    ...
    platform7=play.new_box(color="olivedrab", x=100,y=-150,border_color="darkgreen",border_width=5, width=300,height=20)
...
async def game():
    ...
    if character.is_touching(sea):
        ...
        quit()
    if character.is_touching(korm) and oscar_coins==5:
